...
const socialLinks = [
  ...
  // Add real links later if available
];
    ...
    <footer className="relative overflow-hidden text-white">
      ...
      <div className="relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
              ...
              <ul className="space-y-5">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div className="text-sm text-white/70 leading-relaxed mt-1">
                    <a href="tel:+919154156345" className="hover:text-primary block">+91 91541 56345</a>
                    <a href="tel:+919247937789" className="hover:text-primary block">+91 92479 37789</a>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <a href="mailto:Urbanlife1899@gmail.com" className="text-white/70 hover:text-primary text-sm mt-2 break-words">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <a
                    ...
                    className="text-white/70 hover:text-primary text-sm leading-relaxed mt-2 break-words"
                  >
                    H.No 1-50/M/1, Munganoor Village, Abdullapurmet Mandal,
                    Hayathnagar, Telangana 500070
                  </a>
                </li>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }}>
              ...
              <div className="flex gap-3 mb-8">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-11 h-11 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:text-secondary transition-all"
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md p-5">
                ...
                <p className="text-xs text-white/60 mb-4">Send your event date & guest count. We’ll respond quickly.</p>
        ...
        <div className="border-t border-white/10">
          <div className="container-resort mx-auto px-4 md:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-center">
            <p className="text-white/60 text-sm">
              © {new Date().getFullYear()} Urban Life Retreat. All rights reserved.
            </p>
            <p className="text-white/60 text-sm">
              Made with <span className="text-primary">❤</span> by{" "}
              <a href="https://staffarc.in" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                StaffArc
              </a>
            </p>
          </div>
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.08 }}
          whileTap={{ scale: 0.95 }}
          className="fixed bottom-6 left-6 z-50 w-12 h-12 rounded-2xl bg-white/10 border border-white/10 backdrop-blur-md flex items-center justify-center hover:bg-primary hover:text-secondary transition"
        >
